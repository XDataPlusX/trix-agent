...
description: "Read the live Trix desktop DOM/CSS over CDP."
version: 1.0.0
author: Trix Agent
license: MIT
...
# Inspecting the live Trix desktop DOM
...
`debugging-trix-desktop`), or anything where the real question is "does this
look right".
