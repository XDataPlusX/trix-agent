...
def _save_report_locally(report: str) -> Path:
    ...
    The file is written mode 0600 (owner read/write only) since it holds
    plaintext conversation content. Retention/pruning of old reports is a
    separate product decision and is deliberately not handled here.
    """
