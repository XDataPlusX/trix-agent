...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "trix": {
        "name": "trix",
        "description": "Trix Agent default theme",
        # Registered here (not just as assets/skins/trix.yaml) so it resolves
        # on every install path -- Docker included -- without depending on a
        # file being copied into $HERMES_HOME/skins/ at install time. Keep
        # this dict and assets/skins/trix.yaml in agreement.
        "colors": {
            "banner_border": "#4169e1",
            "banner_title": "#7eb8f6",
            "banner_accent": "#8EA8FF",
        ...
        "spinner": {},
        "branding": {
            "agent_name": "Trix Agent",
            "welcome": "Welcome to Trix Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " Trix ",
            "prompt_symbol": "› ",
            "help_header": "(^_^)? Available Commands",
