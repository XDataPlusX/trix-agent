...
# Steady-state housekeeping trims release well under 1 MB per minute on an
# idle gateway; logging every one of them buried agent.log (issue observed in
# the 2026-09-12 debug report).  1 MB keeps routine noise silent while real
# releases (post-compression, post-delegation, startup) still log at INFO.
_DEFAULT_INFO_LOG_MIN_DELTA_MB = 1.0
