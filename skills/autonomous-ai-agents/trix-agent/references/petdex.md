...
the Trix Agent CLI, TUI, and desktop app. This skill drives the `hermes pets` CLI
...
- Pillow (a core Trix Agent dependency) for sprite decoding — already installed.
...
- The petdex npm CLI installs to `~/.codex/pets`; Trix Agent uses its own
