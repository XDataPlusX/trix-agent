...
version: 1.0.0
author: Teknium (teknium1), Trix Agent
license: MIT
...
- **heartmula** — full songs with vocals from lyrics + tags
  ...
  not installed here (an optional skill, `official/creative/heartmula` — ask whoever administers the machine)
- **audiocraft** — Meta's MusicGen (instrumental text-to-music) and
  AudioGen (sound effects):
  not installed here (an optional skill, `official/creative/audiocraft-audio-generation` — ask whoever administers the machine)
