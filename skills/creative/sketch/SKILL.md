...
version: 1.0.1
author: Trix Agent (adapted from gsd-build/get-shit-done)
license: MIT
...
**Verify variants visually — use Trix's browser tools.** Don't just write HTML and hope it renders; load each variant and look at it:
