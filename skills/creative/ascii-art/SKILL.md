...
```bash
python -m pyfiglet "TRIX" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=TRIX&font=Slant" | boxes -d stone
```
