...
from hermes_cli.release_source import (  # noqa: E402
    RELEASE_REPO_NAME,
    RELEASE_REPO_OWNER,
)

# Changelog entries link back to the repository the release lives in.
# Derived from release_source rather than written out here so the address
# has exactly one home -- it already drifted across six files once.
RELEASE_REPO_WEB_URL = f"https://github.com/{RELEASE_REPO_OWNER}/{RELEASE_REPO_NAME}"
...
def generate_changelog(commits, tag_name, semver, repo_url=RELEASE_REPO_WEB_URL,
