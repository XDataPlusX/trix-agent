...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_choice_picker_callback(
        ...
        if not self._is_callback_user_authorized(
            ...
            await query.answer(text=t("trix.cmd.shared.not_authorized_setting"))
            return
    ...
    async def _handle_callback_query(
        ...
        if data.startswith("ea:"):
            ...
            if len(parts) == 3:
                ...
                if not self._is_callback_user_authorized(
                    ...
                    await query.answer(
                        text=_approval_outcome_text("trix.approval.callback_unauthorized")
                    )
                    return
        ...
        if data.startswith("sc:"):
            ...
            if len(parts) == 3:
                ...
                if not self._is_callback_user_authorized(
                    ...
                    await query.answer(
                        text=_approval_outcome_text("trix.approval.confirm_unauthorized")
                    )
                    return
        ...
        if data.startswith("cl:"):
            ...
            if len(parts) == 3:
                ...
                if not self._is_callback_user_authorized(
                    ...
                    await query.answer(text=t("trix.approval.confirm_unauthorized"))
                    return
        ...
        if not self._is_callback_user_authorized(
            ...
            await query.answer(text=t("trix.update.not_authorized"))
            return
