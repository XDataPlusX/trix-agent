...
# Подписка Coding Plan живёт на ОТДЕЛЬНОМ адресе и ключом от неё обычный
# адрес не пользуется: `https://api.z.ai/api/paas/v4` отвечает на такой ключ
# «Insufficient balance or no resource package» (проверено 2026-09-04 живым
# запросом), потому что там оплата по токенам, а у подписки свой пул.
# Тот же расклад уже описан в каталоге у Alibaba (`alibaba-coding-plan`) и
# Kimi (`kimi-coding`) — здесь он просто не был заведён, и клиент с
# подпиской Z.AI не мог пройти мастер настройки вовсе: своего адреса
# мастер ввести не даёт, а единственный профиль Z.AI вёл на платный.
zai_coding_plan = ZaiProfile(
    name="zai-coding-plan",
    aliases=("glm-coding", "zai-coding", "z.ai-coding-plan"),
    env_vars=("ZAI_CODING_PLAN_API_KEY", "GLM_CODING_PLAN_API_KEY"),
    display_name="Z.AI (Coding Plan)",
    description="Z.AI Coding Plan (subscription tier, separate endpoint)",
