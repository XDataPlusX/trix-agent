...
def cmd_status(args) -> None:
    ...
    # Must agree with client.resolve_global_config_path(), or `honcho status`
    # would print a fallback path the client never reads under contained.
    from hermes_constants import user_home_path

    global_path = user_home_path(".honcho", "config.json")
