...
from hermes_constants import get_hermes_home, user_home_path
...
def _load_config() -> dict:
    ...
    legacy_path = user_home_path(".hindsight", "config.json")
...
def _embedded_profile_env_path(config: dict[str, Any]):
    ...
    return user_home_path(".hindsight", "profiles", f"{_embedded_profile_name(config)}.env")
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def backup_paths(self) -> List[str]:
        ...
        try:
            from pathlib import Path
            legacy_dir = user_home_path(".hindsight")
