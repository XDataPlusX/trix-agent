...
UDS socket lifecycle, trix_tools generation, timeout enforcement,
...
class TestHermesToolsGeneration(unittest.TestCase):
    ...
    def test_file_transport_uses_tempfile_fallback_for_rpc_dir(self):
        src = generate_trix_tools_module(["terminal"], transport="file")
    ...
    def test_uds_transport_serializes_concurrent_calls(self):
        ...
        src = generate_trix_tools_module(["terminal"], transport="uds")
...
class TestExecuteCodeRemoteTempDir(unittest.TestCase):
    def test_execute_remote_uses_backend_temp_dir_for_sandbox(self):
        ...
        self.assertIn("mkdir -p /data/data/com.termux/files/usr/tmp/trix_exec_", mkdir_cmd)
        self.assertIn("HERMES_RPC_DIR=/data/data/com.termux/files/usr/tmp/trix_exec_", run_cmd)
        self.assertIn("rm -rf /data/data/com.termux/files/usr/tmp/trix_exec_", cleanup_cmd)
        self.assertNotIn("mkdir -p /tmp/trix_exec_", mkdir_cmd)
...
class TestExecuteCode(unittest.TestCase):
    ...
    def test_single_tool_call(self):
        ...
        code = """
from trix_tools import terminal
...
"""
    ...
    def test_shell_quote_helper(self):
        ...
        code = """
from trix_tools import shell_quote
...
"""
    ...
    def test_json_parse_helper_bom(self):
        ...
        code = """
from trix_tools import json_parse
...
class TestEnvVarFiltering(unittest.TestCase):
    ...
    def test_trix_rpc_socket_injected(self):
        child_env = self._get_child_env()
...
class TestRpcTokenAuthorization(unittest.TestCase):
    ...
    def test_generated_module_sends_token(self):
        """The generated trix_tools module reads HERMES_RPC_TOKEN and sends it."""
        src = generate_trix_tools_module(["terminal"], transport="uds")
