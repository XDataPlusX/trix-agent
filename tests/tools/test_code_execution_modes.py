...
class TestExecuteCodeModeIntegration(unittest.TestCase):
    ...
    def test_strict_mode_runs_in_tmpdir(self):
        ...
        self.assertIn("trix_sandbox_", result["output"])
    ...
    def test_project_mode_can_still_import_trix_tools(self):
        """Regression: trix_tools still importable from non-tmpdir CWD.

        This is the PYTHONPATH fix — without it, switching to session CWD
        breaks `from trix_tools import terminal`.
        """
        import tempfile
    ...
    def test_strict_mode_can_still_import_trix_tools(self):
