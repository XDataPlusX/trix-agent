...
class TestGmiDoctor:
    ...
    def test_run_doctor_checks_gmi_models_endpoint(self, monkeypatch, tmp_path):
        ...
        # A realistic-looking value, not "***" -- has_usable_secret() (used
        # by _has_provider_env_config since the Trix .env-template fix)
        # deliberately treats "***" as an unfilled placeholder, not a key.
        (home / ".env").write_text("GMI_API_KEY=gmi-test-key-1234567890\n", encoding="utf-8")
