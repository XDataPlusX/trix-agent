...
# Скилл переехал в optional-skills 2026-09-07 (кураторство поставки под
# клиента): в активном наборе его больше нет, но в чекауте он есть, а
# тесту нужен именно НАСТОЯЩИЙ SKILL.md — он копирует его во временный
# каталог и проверяет, что слаг не протекает в /commands. Подставить
# выдуманный файл значило бы проверять фильтр в вакууме.
_SKILL_AUTHORING_MD = (
    _REPO_ROOT
    / "optional-skills"
