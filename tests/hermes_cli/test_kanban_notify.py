...
def kanban_home(tmp_path, monkeypatch):
    ...
    # This fixture writes no config.yaml, so display.language resolves to
    # whatever DEFAULT_CONFIG ships (Trix Agent defaults it to "ru"). Pin the
    # gateway's static-string language explicitly so assertions on the
    # rendered command output stay about the kanban behavior under test, not
    # about the product's default UI language.
