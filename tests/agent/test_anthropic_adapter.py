...
class TestReadClaudeCodeCredentials:
    ...
    def test_reads_valid_credentials(self, tmp_path, monkeypatch, isolated_user_home):
    ...
    def test_ignores_primary_api_key_for_native_anthropic_resolution(self, tmp_path, monkeypatch, isolated_user_home):
...
class TestResolveAnthropicToken:
    ...
    def test_prefers_oauth_token_over_api_key(self, monkeypatch, tmp_path, isolated_user_home):
        monkeypatch.setenv("ANTHROPIC_API_KEY", "sk-ant-api03-mykey")
        monkeypatch.setenv("ANTHROPIC_TOKEN", "sk-ant-oat01-mytoken")
        monkeypatch.delenv("CLAUDE_CODE_OAUTH_TOKEN", raising=False)
        assert resolve_anthropic_token() == "sk-ant-oat01-mytoken"

    def test_does_not_resolve_primary_api_key_as_native_anthropic_token(self, monkeypatch, tmp_path, isolated_user_home):
    ...
    def test_falls_back_to_api_key_when_no_oauth_sources_exist(self, monkeypatch, tmp_path, isolated_user_home):
    ...
    def test_api_key_wins_over_auto_discovered_claude_code_credentials(
        self, monkeypatch, tmp_path, isolated_user_home
    ):
        monkeypatch.setenv("ANTHROPIC_API_KEY", "sk-ant...ykey")
        monkeypatch.delenv("ANTHROPIC_TOKEN", raising=False)
        monkeypatch.delenv("CLAUDE_CODE_OAUTH_TOKEN", raising=False)
    ...
    def test_falls_back_to_claude_code_credentials(self, monkeypatch, tmp_path, isolated_user_home):
        monkeypatch.delenv("ANTHROPIC_API_KEY", raising=False)
        monkeypatch.delenv("ANTHROPIC_TOKEN", raising=False)
        monkeypatch.delenv("CLAUDE_CODE_OAUTH_TOKEN", raising=False)
        cred_file = tmp_path / ".claude" / ".credentials.json"
    ...
    def test_falls_back_to_anthropic_credential_pool_oauth(self, monkeypatch, tmp_path, isolated_user_home):
        monkeypatch.delenv("ANTHROPIC_API_KEY", raising=False)
        monkeypatch.delenv("ANTHROPIC_TOKEN", raising=False)
        monkeypatch.delenv("CLAUDE_CODE_OAUTH_TOKEN", raising=False)
    ...
    def test_api_key_wins_over_anthropic_credential_pool_oauth(self, monkeypatch, tmp_path, isolated_user_home):
        monkeypatch.setenv("ANTHROPIC_API_KEY", "sk-ant...ykey")
        monkeypatch.delenv("ANTHROPIC_TOKEN", raising=False)
        monkeypatch.delenv("CLAUDE_CODE_OAUTH_TOKEN", raising=False)
        monkeypatch.setattr(
    ...
    def test_pool_entry_with_null_access_token_does_not_crash(self, monkeypatch, tmp_path, isolated_user_home):
    ...
    def test_pool_api_key_only_entry_is_not_returned_as_token(self, monkeypatch, tmp_path, isolated_user_home):
    ...
    def test_pool_resolution_is_read_only(self, monkeypatch, tmp_path, isolated_user_home):
    ...
    def test_prefers_refreshable_claude_code_credentials_over_static_anthropic_token(self, monkeypatch, tmp_path, isolated_user_home):
        monkeypatch.delenv("ANTHROPIC_API_KEY", raising=False)
...
class TestRefreshOauthToken:
    def test_returns_none_without_refresh_token(self, tmp_path, monkeypatch, isolated_user_home):
    ...
    def test_successful_refresh(self, tmp_path, monkeypatch, isolated_user_home):
        monkeypatch.setattr(
            "agent.anthropic_adapter.read_claude_code_credentials", lambda: None
        )
    ...
    def test_failed_refresh_returns_none(self, tmp_path, monkeypatch, isolated_user_home):
        monkeypatch.setattr(
            "agent.anthropic_adapter.read_claude_code_credentials", lambda: None
        )
        creds = {
...
class TestWriteClaudeCodeCredentials:
    def test_writes_new_file(self, tmp_path, monkeypatch, isolated_user_home):
    ...
    def test_preserves_existing_fields(self, tmp_path, monkeypatch, isolated_user_home):
    ...
    def test_credentials_file_created_with_0o600(self, tmp_path, monkeypatch, isolated_user_home):
...
class TestResolveWithRefresh:
    def test_auto_refresh_on_expired_creds(self, monkeypatch, tmp_path, isolated_user_home):
    ...
    def test_static_env_oauth_token_does_not_block_refreshable_claude_creds(self, monkeypatch, tmp_path, isolated_user_home):
        monkeypatch.delenv("ANTHROPIC_API_KEY", raising=False)
...
class TestRunOauthSetupToken:
    ...
    def test_returns_token_from_credential_files(self, monkeypatch, tmp_path, isolated_user_home):
    ...
    def test_returns_none_when_no_creds_found(self, monkeypatch, tmp_path, isolated_user_home):
